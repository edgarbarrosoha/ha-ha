...
### Last Session
- **Date:** 2026-02-27
- **Type:** Notion MCP debug
- **Achievements:** Token validado (curl OK, 20 objetos accesibles). Root cause: OPENAPI_MCP_HEADERS no pasa token. Fix: NOTION_TOKEN directo en settings.json. Reinicio pendiente para activar.
