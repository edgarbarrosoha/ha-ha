...
| Producto | Status |
|----------|--------|
| Entrepreneurship con HA | Syllabus listo, Betty + Sarahí avanzan canvases |
...
- [ ] Oscar terminando documentación para cerrar proyecto
- [ ] 2 new devs onboarding
- [ ] D2: Text Agent App
- [ ] D3: Voice Agent App
- [ ] D4: Dual-Agent Dialogue (Debate)
