# 02-Community — Tec Beyond

> Las personas: stakeholders, red de colaboración y audiencias.
...
## Audiencias de la Plataforma

### Primarias (Usuarios)

| Audiencia | Tamaño Est. | Propuesta de Valor |
|-----------|-------------|-------------------|
| **Empresarios Activos** | ~300 (León) | Match de negocios, networking, contenido personalizado |
| **Alumni (Egresados)** | ~270 (9 generaciones) | Comunidad continua, lifelong learning, conexiones |
| **Candidatos Potenciales** | Pipeline | Detección temprana, nurturing para futuras generaciones |

### Secundarias (Beneficiarios)

| Audiencia | Propuesta de Valor |
|-----------|-------------------|
| **Consejo Campus León** | Hallazgos estratégicos, inteligencia de la red, ROI visible |
| **Directivos del Tec** | Modelo replicable, innovación educativa, vinculación empresarial |
| **ESBAC** | Fortalecimiento del ecosistema empresarial |
| **Familias de empresarios** | Extensión de beneficios, comunidad ampliada |
...
> "Una comunidad que trabaja para ti incluso cuando no estás."

- Conexiones de negocio facilitadas por IA
- Contenido personalizado según tu industria e intereses
- Acceso a una red de alto nivel curada
- Experiencias memorables que fortalecen lazos

### Para el Consejo / ESBAC

> "Inteligencia accionable de tu red más valiosa."

- Dashboard de hallazgos en tiempo real
- Detección de oportunidades y riesgos
- Pipeline de candidatos para futuras generaciones
- ROI medible de la inversión en comunidad

### Para Directivos del Tec

> "Un modelo de vinculación empresarial escalable y replicable."

- Prueba de concepto en León → escala nacional
- Innovación en educación ejecutiva
- Diferenciador vs. IPADE y competencia
- Datos para mejorar programas continuamente
