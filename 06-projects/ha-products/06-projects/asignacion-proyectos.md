...
| Prioridad | Proyecto | Razon |
|---|---|---|
| **P0** | TaaS | Infraestructura. Sin el motor, todo se construye sobre fundamentos ad-hoc |
| **P0** | Dev-with-AI | Infraestructura. Define como el equipo trabaja con IA |
| **P0** | MARA | Es el ChatGPT de nuestro GPT. Sin la interfaz, el motor es inaccesible |
